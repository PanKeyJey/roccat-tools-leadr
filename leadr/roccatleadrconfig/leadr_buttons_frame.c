...
static ButtonList button_list[leadr_PHYSICAL_BUTTON_NUM] = {
	...
	{N_("Left Backward"), leadr_BUTTON_INDEX_LEFT_BACKWARD, leadr_KEY_COMBO_BOX_GROUP_NOT_ANALOG,
		leadr_BUTTON_INDEX_SHIFT_LEFT_BACKWARD, ROCCAT_KEY_COMBO_BOX_GROUP_EASYSHIFT | leadr_KEY_COMBO_BOX_GROUP_NOT_ANALOG},
	{N_("Right Forward"), leadr_BUTTON_INDEX_RIGHT_FORWARD, leadr_KEY_COMBO_BOX_GROUP_NOT_ANALOG,
		leadr_BUTTON_INDEX_SHIFT_RIGHT_FORWARD, ROCCAT_KEY_COMBO_BOX_GROUP_EASYSHIFT | leadr_KEY_COMBO_BOX_GROUP_NOT_ANALOG},
	{N_("Right Backward"), leadr_BUTTON_INDEX_RIGHT_BACKWARD, ROCCAT_KEY_COMBO_BOX_GROUP_ANALOG,
		leadr_BUTTON_INDEX_SHIFT_RIGHT_BACKWARD, ROCCAT_KEY_COMBO_BOX_GROUP_ANALOG | ROCCAT_KEY_COMBO_BOX_GROUP_EASYSHIFT},
	...
	{N_("Thumb Backward"), leadr_BUTTON_INDEX_THUMB_BACKWARD, ROCCAT_KEY_COMBO_BOX_GROUP_ANALOG,
		leadr_BUTTON_INDEX_SHIFT_THUMB_BACKWARD, ROCCAT_KEY_COMBO_BOX_GROUP_ANALOG | ROCCAT_KEY_COMBO_BOX_GROUP_EASYSHIFT},
	...
	{N_("X-Celerator Up"), leadr_BUTTON_INDEX_X_CELERATOR_UP, ROCCAT_KEY_COMBO_BOX_GROUP_ANALOG,
		leadr_BUTTON_INDEX_SHIFT_X_CELERATOR_UP, ROCCAT_KEY_COMBO_BOX_GROUP_ANALOG | ROCCAT_KEY_COMBO_BOX_GROUP_EASYSHIFT},
	{N_("X-Celerator Down"), leadr_BUTTON_INDEX_X_CELERATOR_DOWN, ROCCAT_KEY_COMBO_BOX_GROUP_ANALOG,
		leadr_BUTTON_INDEX_SHIFT_X_CELERATOR_DOWN, ROCCAT_KEY_COMBO_BOX_GROUP_ANALOG | ROCCAT_KEY_COMBO_BOX_GROUP_EASYSHIFT},
};
