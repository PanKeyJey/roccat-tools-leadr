...
static ButtonList button_list[leadr_PHYSICAL_BUTTON_NUM] = {
	...
	{N_("Left Backward"), leadr_BUTTON_INDEX_LEFT_BACKWARD, ROCCAT_KEY_COMBO_BOX_GROUP_ANALOG,
		leadr_BUTTON_INDEX_SHIFT_LEFT_BACKWARD, ROCCAT_KEY_COMBO_BOX_GROUP_ANALOG | ROCCAT_KEY_COMBO_BOX_GROUP_EASYSHIFT},
	...
	{N_("X-Celerator Up"), leadr_BUTTON_INDEX_X_CELERATOR_UP, leadr_KEY_COMBO_BOX_GROUP_NOT_ANALOG,
		leadr_BUTTON_INDEX_SHIFT_X_CELERATOR_UP, leadr_KEY_COMBO_BOX_GROUP_NOT_ANALOG | ROCCAT_KEY_COMBO_BOX_GROUP_EASYSHIFT},
	{N_("X-Celerator Down"), leadr_BUTTON_INDEX_X_CELERATOR_DOWN, leadr_KEY_COMBO_BOX_GROUP_NOT_ANALOG,
		leadr_BUTTON_INDEX_SHIFT_X_CELERATOR_DOWN, leadr_KEY_COMBO_BOX_GROUP_NOT_ANALOG | ROCCAT_KEY_COMBO_BOX_GROUP_EASYSHIFT},
};
