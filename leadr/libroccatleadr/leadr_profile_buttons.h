...
typedef enum {
	...
	leadr_BUTTON_INDEX_MIDDLE,
        ...
        leadr_BUTTON_INDEX_LEFT_BACKWARD,
        leadr_BUTTON_INDEX_RIGHT_FORWARD,
        leadr_BUTTON_INDEX_RIGHT_BACKWARD,
        leadr_BUTTON_INDEX_FIN_LEFT,
        leadr_BUTTON_INDEX_FIN_RIGHT,
        leadr_BUTTON_INDEX_THUMB_FORWARD,
        leadr_BUTTON_INDEX_THUMB_BACKWARD,
        leadr_BUTTON_INDEX_THUMB_PEDAL,
        leadr_BUTTON_INDEX_X_CELERATOR_UP,
        leadr_BUTTON_INDEX_X_CELERATOR_DOWN,
	...
	leadr_BUTTON_INDEX_SHIFT_MIDDLE,
        ...
        leadr_BUTTON_INDEX_SHIFT_LEFT_BACKWARD,
        leadr_BUTTON_INDEX_SHIFT_RIGHT_FORWARD,
        leadr_BUTTON_INDEX_SHIFT_RIGHT_BACKWARD,
        leadr_BUTTON_INDEX_SHIFT_FIN_LEFT,
        leadr_BUTTON_INDEX_SHIFT_FIN_RIGHT,
        leadr_BUTTON_INDEX_SHIFT_THUMB_FORWARD,
        leadr_BUTTON_INDEX_SHIFT_THUMB_BACKWARD,
        leadr_BUTTON_INDEX_SHIFT_THUMB_PEDAL,
        leadr_BUTTON_INDEX_SHIFT_X_CELERATOR_UP,
        leadr_BUTTON_INDEX_SHIFT_X_CELERATOR_DOWN,
} leadrButtonIndex;
